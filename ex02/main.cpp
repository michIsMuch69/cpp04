...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/13 13:08:30 by jedusser          #+#    #+#             */
/*   Updated: 2025/03/13 13:10:43 by jedusser         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{   
    ...
    //  ne fonctionne pas car mtnt la classe animale est virtuelle pure, donc non instanciable.
    testSubject();
    testDeepCopy();
    testAnimalArray();
